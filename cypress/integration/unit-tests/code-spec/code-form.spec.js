...
context('Open Design Form', () => {
  ...
  it('Values should be autofilled when design name is selected', () => {
    ...
    cy.get('#nameselect')
      ...
      .then(name => {
        ...
        cy.window()
          .get('#endescriptionwhatItDoes')
          .should('not.have.value', '');
        cy.window()
          .get('#frdescriptionwhatItDoes')
          .should('not.have.value', '');
        cy.window()
          .get('#enhomepageURL')
          .should('not.have.value', '');
  ...
  it('Should reset all fields when reset is activated', () => {
    ...
    cy.window()
      ...
      .type('Test');
    cy.window()
      .get('#frdescriptionhowItWorks')
      .type('Test');
    cy.window()
      .get('#endescriptionhowItWorks')
      .type('Test');
    cy.window()
      .get('#designStatus')
      .select('Original design');
    cy.window()
      .get('#adminCode')
      .children()
      .eq(1)
